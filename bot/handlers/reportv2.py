...
Flow:
  /reportv2 <link_channel> → tampil menu kategori → eksekusi

Tidak ada FSM waiting_message_link — langsung ke pilihan kategori.
"""
...
from utils.parsers import is_valid_telegram_link, parse_channel_link
...
# ─────────────────────────────────────────────────────────────
# OPTION MAP — sama persis dengan report.py tapi prefix "v2_"
# ─────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────
# KEYBOARD FACTORY — sama dengan report.py tapi callback prefix "v2_r..."
# ─────────────────────────────────────────────────────────────
...
async def cb_v2_level1(callback: CallbackQuery, state: FSMContext) -> None:
    ...
    # Langsung eksekusi (I don't like it)
